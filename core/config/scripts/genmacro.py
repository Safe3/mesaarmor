...
genAllowRule(outFileObject,"allowbinder", doc,mode)
genAllowRule(outFileObject,"allowprop", doc,mode)
genAllowRule(outFileObject,"allowsvc", doc,mode)
genAllowRule(outFileObject,"allowks", doc,mode)
genAllowRule(outFileObject,"allowdrm", doc,mode)
