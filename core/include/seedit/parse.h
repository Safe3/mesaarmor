...
void register_domain(char *, int, int);
...
void inline_rule(char *);
int register_binder_acl(char **);
int register_prop_acl(char *);
int register_svc_acl(char *, int);
int register_ks_acl(char *);
int register_drm_acl(char *);
...
/**
 *  permissions for binder
 */

#define MANAGE_PRM		0x01
#define CALL_PRM		0x02
#define TRANSFER_PRM		0x04

#define MANAGE_STR		"m"
#define CALL_STR		"c"
#define TRANSFER_STR		"t"
...
#define ADD_PRM			0x01
#define FIND_PRM		0x02
#define LIST_PRM		0x04
...
/**
 *  permissions for Android Key Store
 */

#define GET_PRM			0x01
#define INSERT_PRM		0x02
#define LOCK_PRM		0x04
#define SIGN_PRM		0x08
#define USER_PRM		0x10
#define ADDA_PRM		0x20  /* add_auth */
