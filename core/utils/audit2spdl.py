...
def printUsage():
    sys.stderr.write("audit2spdl [-d] [-a] [-l] [-s] [-r] [-i <inputfile> ] [-n <path_inode_file>] \n")
    ...
    sys.stderr.write("\t-n\tread input from <path_inode_file>\n")
...
try:
    opts, args = getopt.getopt(sys.argv[1:], "i:sdvarlo:n:", ["input=","dmesg","verbose","audit","load_policy","output","secure"])
