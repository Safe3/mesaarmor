...
#define ATTRIBUTE_FILE                   "attributes"
...
#define MCS_FILE                         "mcs"
#define DEFAULT_AOSP_SEPOLICY_DIR          "external/sepolicy"
#define GLOBAL_MACROS_FILE		"global_macros"
#define NEVERALLOW_MACROS_FILE		"neverallow_macros"
#define MLS_MACROS_FILE			"mls_macros"
#define MLS_FILE			"mls"
#define POLICY_CAPABILITIES_FILE	"policy_capabilities"
#define TE_MACROS_FILE			"te_macros"
#define IOCTL_MACROS_FILE		"ioctl_macros"
#define ROLES_FILE			"roles"
#define USERS_FILE			"users"
#define PORT_CONTEXT_FILE		"port_contexts"
#define SEEDIT_MACROS_TE_FILE		"seedit_macros.te"
#define TYPEATTRIBUTE_TE_FILE		"typeattribute.te"
#define SVCATTRIBUTE_TE_FILE		"svcattribute.te"
#define DONTAUDIT_TE_FILE		"dontaudit.te"
#define CUSTOM_MACROS_TE_FILE		"custom_macros.te"
...
typedef struct basepolicy_t{
  ...
  char * mcs;
  char * global_macros;
  char * neverallow_macros;
  char * mls_macros;
  char * mls;
  char * policy_capabilities;
  char * te_macros;
  char * ioctl_macros;
  char * roles;
  char * users;
  char * port_context;
  char * seedit_macros_te;
  char * typeattribute_te;
  char * svcattribute_te;
  char * dontaudit_te;
  char * custom_macros_te;
} BASEPOLICY;
...
void set_base_policy_files(char * basedir, char * aosp_sepolicy_dir, char * device_sepolicy_dir);
