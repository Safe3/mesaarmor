...
#TODO: hard code now, need to figure out later
gConf = {'cross_flag': True,
         'all.sp' : '/aosp/out/target/product/hammerhead/obj/ETC/test_sepolicy_intermediates/all.sp',
         'sppath' : '/etc/seedit/policy/',
         'guipath' : '/usr/sbin/',
         'generated.conf': '/aosp/out/target/product/hammerhead/obj/ETC/test_sepolicy_intermediates/policy.conf',
         'seedit-load' : '/usr/sbin/seedit-load',
         'seedit-load.conf' : '/usr/share/seedit/seedit-load.conf',
         'converter.conf': '/aosp/external/mesaarmor/core/config/base_policy/converter.conf',
         'spdl_spec.xml': '/aosp/external/mesaarmor/core/config/base_policy/spdl_spec.xml'
         }
